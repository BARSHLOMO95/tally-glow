...
const statusColors: Record<InvoiceStatus, string> = {
  ...
  'ממתין לבדיקה ידנית': 'bg-red-100 text-red-700 border-red-200',
};
...
const entryMethodColors: Record<EntryMethod, string> = {
  ...
  'gmail_sync': 'bg-purple-100 text-purple-700 border-purple-200',
};
              ...
              sortedInvoices.map((invoice, index) => (
                ...
                >
                  ...
                  <TableCell className="py-4 px-2 text-center">
                    {(invoice.image_url || invoice.preview_image_url) ? (
                      <button
                        data-image
